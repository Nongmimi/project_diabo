          ...
          child: Column(
            children: <Widget>[
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        child: CircleAvatar(
                          backgroundColor: const Color.fromARGB(255, 208, 180, 180),
                          radius: 15.0,
                          child: IconButton(
              ...
              Column(
                ...
                children: [
                  _buildTextField(controller: _fullNameController, label: "ชื่อ - นามสกุล", icon: Icons.person),
                  const Divider(color: Colors.transparent),
                  _buildTextField(controller: _usernameController, label: "Username", icon: Icons.assignment_ind),
                  const Divider(color: Colors.transparent),
                  _buildTextField(controller: _emailController, label: "Email", icon: Icons.email),
                  const Divider(color: Colors.transparent),
                  _buildTextField(controller: _passwordController, label: "Password", icon: Icons.lock, obscureText: true, hint: "รหัสผ่านต้องมีอย่างน้อย 6 ตัว"),
                  const Divider(color: Colors.transparent),
              ...
              //const Divider(color: Colors.transparent),
              _buildTextField(controller: _weightController, label: "น้ำหนัก", icon: Icons.monitor_weight, hint: ".kg"),
              const Divider(color: Colors.transparent),
              _buildTextField(controller: _heightController, label: "ส่วนสูง", icon: Icons.emoji_people, hint: ".cm"),
              const Divider(color: Colors.transparent),
